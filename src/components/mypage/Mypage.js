...
const Mypage = () => {
    ...
    const filteredData = data.filter((row) => {
        ...
        if (filter.category !== "전체" && row.moimCategory !== filter.category)
            return false;
        return true;
    });
                ...
                >
                    ...
                    >
                        ...
                        <Button
                            ...
                            onClick={() => {
                                if (
                                    verificationCodeRef.current.value === serverCodeRef.current
                                ) {
                                    // 여기에 맞으면 실행할 함수를 호출합니다.
            ...
            <div id="layoutSidenav">
                ...
                >
                    <div>
                        <div
                            className="tabs"
                            style={{ marginLeft: "424px", marginTop: "10px" }}
                        >
                            <TabButton
                                        ...
                                        <UserInfoSection>
                                            ...
                                            <TabPanel value={value} index={0}>
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        <MenuItem value="전체" sx={{ fontSize: "14px" }}>
                                                            진행여부
                                                        </MenuItem>
                                                        <MenuItem value="진행중" sx={{ fontSize: "14px" }}>
                                                            진행중
                                                        </MenuItem>
                                                        <MenuItem value="종료" sx={{ fontSize: "14px" }}>
                                                            종료
                                                        </MenuItem>
                                                    </Select>
                                                    <Select
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <Typography
                                                                        ...
                                                                        sx={{ marginBottom: "6px" }}
                                                                    >
                                                                        지역 : {friend.user_addr3 || "지역 없음"}
                                                                    </Typography>
                                                                    <Typography variant="body2">
                                                                        상태메세지:{" "}
                                                                        {friend.user_status_message ||
                                                                            "상태 메세지 없음"}
                                                                    </Typography>
                                                                </BoxContent>
                                                            </Grid>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div>
                                                                            <Button
                                                                                ...
                                                                                sx={{ marginRight: "5px" }}
                                                                                onClick={() =>
                                                                                    acceptRequestFriend(friend.id, 1)
                                                                                }
                                                                            >
                                                                                수락하기
                                                                            </Button>
                                                                            <Button
                                                                                ...
                                                                                color="secondary"
                                                                                onClick={() =>
                                                                                    acceptRequestFriend(friend.id, 0)
                                                                                }
                                                                            >
                                                                                거절하기
                                                                            </Button>
