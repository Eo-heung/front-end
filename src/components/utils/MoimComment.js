...
const MoimComment = ({ moimId, boardId }) => {
    ...
    const fetchComments = async () => {
        try {
            const response = await axios.get(`${SPRING_API_URL}/comment/${moimId}/${boardId}/list-co`, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.getItem("ACCESS_TOKEN")}`
                },
                params: {
                                    ...
                                    <div key={comment.commentId}>
                                        ...
                                        {isLoginUserTheWriter &&
                                            <CommentButtonZone>
                                                ...
                                                <CommentButton type="button" variant="outlined" size="small" onClick={handleDeleteClick(comment.commentId)}>삭제</CommentButton>
                                            </CommentButtonZone>
                                        }
